...
export default function AppLogo() {
    return (
        <>
            ...
            <div className="text-gray-700 flex flex-col aspect-square size-12 items-center justify-center rounded-md">
                <AppLogoIcon className="size-100 fill-currentcolor " />
            </div>
